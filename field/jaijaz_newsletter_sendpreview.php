...
class Jojo_Field_jaijaz_newsletter_sendpreview extends Jojo_Field
{
    var $rows;
    var $options;
    ...
    function displayedit()
    {
        ...
        return $smarty->fetch('admin/fields/jaijaz_newsletter_sendpreview.tpl');
    }
    ...
    {
        global $smarty;
        $js = $smarty->fetch('admin/fields/jaijaz_newsletter_sendpreview_js.tpl');
        return $js;
    }
